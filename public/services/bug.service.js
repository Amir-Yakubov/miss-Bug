...
function query(filterBy = getDefaultFilter(), sortBy = getDefaultSort()) {
    const queryParams = `?title=${filterBy.title}&minSeverity=${filterBy.minSeverity}&labels=${filterBy.labels}&pageIdx=${filterBy.pageIdx}&sortByCat=${sortBy.sortByCat}&desc=${sortBy.desc}&pageSize=${filterBy.pageSize}`
